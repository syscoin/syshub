...
function UserTwoFA({authData, onTwoFAChange, userPhone}) {
    const {user, firebase, updateCurrentActionsUser, logoutUser} = useUser();
            ...
            if (password) {
                ...
                if (code) {
                    ...
                    try {
                        ...
                        await updateCurrentActionsUser(currentUserDataUpdate, {method: 'gauth-disabled'}).catch(err => {
                            throw err;
                        });
    ...
    return (
        <div className="cols-top cols">
            ...
            >
                <SMS2FAForm onClose={closeSMSAndLogout} appVerifier={window.recaptchaVerifier}/>
            </CustomModal>
