        ...
        <Grid container>
          ...
          <Grid md={12}>
            ...
            <p className="UserDelete-text">
              Your account will be deleted completely, after a 7 day grace period. Your username
              will become available for registration and all your information will be remove from
