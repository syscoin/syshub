...
class HeaderStats extends Component {
  render() {
    ...
    const changeRate = `${(1000 / this.props.sysStatsValue.exchange_rates.btc_usd).toFixed(
      5
    )} BTC/1000 USD`;
    const masternodes = `${this.props.sysStatsValue.general.registered_masternodes_verified} / ${
