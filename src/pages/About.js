                    ...
                    <div className="col-lg-7 col-md-12 col-sm-12 order-2 order-lg-1">
                        <div className="custom__about__left">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li><i className="fa fa-angle-right pr-1"></i> {t('about.masternodes.featureList.f3')}</li>
                                <li><i className="fa fa-angle-right pr-1"></i> {t('about.masternodes.featureList.f4')}</li>
                            </ul>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12">
                        <div className="custom__about__left text-white text-center text-lg-left">
                            ...
                            <p className="lead font-italic">{t('about.governance.question')}</p>
            ...
            <div className="container">
                ...
                <div className="row my-5 justify-content-center">
                    <div className="col-lg-10 col-md-12 col-sm-12 text-center text-white">
                        <p>{t('about.seniority.note.n1.p1')} <b>{t('about.seniority.note.n1.p2')} </b>. {t('about.seniority.note.n1.p3')} <b>{t('about.seniority.note.n1.p4')}</b> {t('about.seniority.note.n1.p5')}</p>
                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-12 text-center text-white">
                        ...
                        <ul className="list-unstyled Requirements__list mb-0">
                            <li><i className="fa fa-angle-right"></i> {t('about.requirements.requirement.r1')}</li>
                            <li><i className="fa fa-angle-right"></i> {t('about.requirements.requirement.r2')}</li>
                            <li><i className="fa fa-angle-right"></i> {t('about.requirements.requirement.r3')}</li>
                            <li><i className="fa fa-angle-right"></i> {t('about.requirements.requirement.r4')}</li>
                            <li><i className="fa fa-angle-right"></i> {t('about.requirements.requirement.r5')}</li>
                            <li><i className="fa fa-angle-right"></i> {t('about.requirements.requirement.r6')}</li>
                            <li><i className="fa fa-angle-right"></i> {t('about.requirements.requirement.r7')}</li>
                        </ul>
                    </div>
                </div>
            </div>
