                ...
                <div className="row align-items-center">
                    <div className="col-lg-6 col-md-12 col-sm-12 order-lg-first">
                        <div className="banner_text text-center text-lg-left ">
                            <h1 className="animation display-3" data-animation="fadeInUp" data-animation-delay="1.1s">Syscoin Masternodes</h1>
                            <p className="animation" data-animation="fadeInUp" data-animation-delay="1.3s"> Everything you need to know about Masternodes </p>
                            <div className="btn_group animation mt-4" data-animation="fadeInUp" data-animation-delay="1.4s"> 
                                <Link to="/about" className="btn btn-default btn-radius content-popup">Learn More<i className="fa fa-long-arrow-right pl-3"></i></Link> 
                            </div>
                        </div>
                    </div>
