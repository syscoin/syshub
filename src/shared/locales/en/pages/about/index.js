const about = {
  about: {
    ...
    rewards: {
      ...
      question: 'How does Decentralized Governance work?',
      description: {
        d1: '75% of each regular block reward is distributed to SentryNode operators as an incentive to continue running the node. Each payout amounts to roughly 25 SYS, though this will increase over time due to the Seniority Benefits mechanism. The likelihood of a SentryNode receiving a payout is inversely proportional to the total number of SentryNodes on the network. At the time of writing, a SentryNode is likely to receive a 25 SYS reward roughly once every 24 hours.',
        d2: 'As a seniority benefit, SentryNode operators receive a 35% bonus to their base reward after one year, and a 100% bonus after 2.5 years. This benefit is paid only if the collateral for an active SentryNode is kept locked at the same address for the entire qualification period.',
      },
    },
    seniority: {
      title: 'SentryNode Seniority Explained',
      ...
      note: { // check /About for more context on how to translate these..
        ...
        n2: 'Stopping your Syscoin SentryNode, restarting your server, closing QT, upgrading SentryNodes, Initialising your SentryNode, changing your IP address, and anything you can possibly think of does not effect your Seniority.',
      },
    },
    requirements: {
      title: 'Requirements to Setup a Syscoin SentryNode',
      requirement: {
        r1: '100,000 Syscoin',
